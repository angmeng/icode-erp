...
class PaymentReceivedsControllerTest < ActionController::TestCase
  ...
  test "should create payment_received" do
    assert_difference('PaymentReceived.count') do
      post :create, payment_received: { bank: @payment_received.bank, cheque_amount: @payment_received.cheque_amount, cheque_date: @payment_received.cheque_date, cheque_no: @payment_received.cheque_no, outport_cheque: @payment_received.outport_cheque, payment_date: @payment_received.payment_date, place: @payment_received.place, status_id: @payment_received.status_id, third_party_cheque: @payment_received.third_party_cheque, trade_company_id: @payment_received.trade_company_id, updated_by: @payment_received.updated_by }
    end
  ...
  test "should update payment_received" do
    put :update, id: @payment_received, payment_received: { bank: @payment_received.bank, cheque_amount: @payment_received.cheque_amount, cheque_date: @payment_received.cheque_date, cheque_no: @payment_received.cheque_no, outport_cheque: @payment_received.outport_cheque, payment_date: @payment_received.payment_date, place: @payment_received.place, status_id: @payment_received.status_id, third_party_cheque: @payment_received.third_party_cheque, trade_company_id: @payment_received.trade_company_id, updated_by: @payment_received.updated_by }
    assert_redirected_to payment_received_path(assigns(:payment_received))
  end
