...
class ColorsControllerTest < ActionController::TestCase
  ...
  test "should create color" do
    assert_difference('Color.count') do
      post :create, color: { color_code: @color.color_code, quotation_request_form_id: @color.quotation_request_form_id }
    end
  ...
  test "should update color" do
    put :update, id: @color, color: { color_code: @color.color_code, quotation_request_form_id: @color.quotation_request_form_id }
    assert_redirected_to color_path(assigns(:color))
  end
