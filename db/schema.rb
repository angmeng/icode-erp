...
ActiveRecord::Schema.define(:version => 20120510184417) do
  ...
  add_index "purchase_order_items", ["unit_measurement_id"], :name => "index_purchase_order_items_on_unit_measurement_id"
